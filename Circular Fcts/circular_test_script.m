%compare linear with circular convolution (MATLAB and my function)
...
y = cconv(x,h); % MATLAB built in circular conv fct
y_circ = circular_conv(x,h); % my circular convolution fct
